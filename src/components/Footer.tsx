        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a 
                  href={`mailto:${BUSINESS_INFO.email}?subject=Pool Service Inquiry&body=Hi Julio,%0D%0A%0D%0AI'm interested in your pool services.%0D%0A%0D%0APlease provide more information about:%0D%0A- Pool maintenance services%0D%0A- Pool repair services%0D%0A- Pricing and availability%0D%0A%0D%0AThank you!`}
                  className="text-gray-300 hover:text-white transition-colors flex items-center space-x-2"
                >
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
